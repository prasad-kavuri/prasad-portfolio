...
export const demos: Demo[] = [
  ...
  },
  {
    ...
    businessOutcome: "Operational guardrails for enterprise AI: RBAC, spend analytics, token budgets, and OpenTelemetry observability in a single control surface.",
