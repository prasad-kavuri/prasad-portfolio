...
export const metadata: Metadata = {
  ...
  description:
    "AI engineering executive leading 10 production AI systems across agentic workflows, LLM orchestration, and enterprise transformation. 20+ years experience, 200+ engineers led, India's first Agentic AI platform.",
  keywords: [
    "AI Engineering",
    "Agentic AI",
    "LLM Orchestration",
  ...
  openGraph: {
    title: "Prasad Kavuri — VP / Head of AI Engineering",
    description: "AI Engineering Executive. 10 production AI systems. 20+ years. 200+ engineers led. Open to VP/Head of AI Engineering roles.",
  ...
  twitter: {
    card: "summary",
    title: "Prasad Kavuri — VP / Head of AI Engineering",
    description: "AI Engineering Executive. 10 production AI systems. 20+ years. Open to VP/Head of AI roles.",
