...
const ROLE_DIMENSIONS = [
  { id: 'vp-ai', label: 'Director / VP / Head of AI Engineering', score: 97, rationale: 'Built and led 200+ eng orgs at Krutrim & Ola; currently Head of AI Platform & Agentic Solutions at Zip. $10M+ revenue, 70% cost reduction, eval-gated CI.' },
      ...
      <div className="mx-auto max-w-5xl px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-muted-foreground">
            Head of AI Platform &amp; Agentic Solutions at Zip · Chicago
          </p>
