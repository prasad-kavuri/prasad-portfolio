...
export const alt = 'Why Most Enterprise AI Initiatives Stall — Prasad Kavuri';
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ fontSize: 42, fontWeight: 700, color: TEXT_PRIMARY, lineHeight: 1.15, marginBottom: 24 }}>
            Why Most Enterprise AI
            <br />Initiatives Stall Before
            <br />They Matter
          </div>
          <div style={{ fontSize: 18, color: TEXT_MUTED, lineHeight: 1.5, flex: 1 }}>
            The pilots work. The demos impress. Then nothing ships to production.
            The problem isn&apos;t the technology — it&apos;s platform thinking.
          </div>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginTop: 24 }}>
            <span style={{ fontSize: 14, color: TEXT_MUTED }}>Prasad Kavuri</span>
            <span style={{ fontSize: 14, color: CARD_BORDER }}>·</span>
            <span style={{ fontSize: 14, color: TEXT_MUTED }}>Head of AI Platform & Agentic Solutions</span>
          </div>
        </div>
