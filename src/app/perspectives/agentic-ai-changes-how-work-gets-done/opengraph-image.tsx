...
export const alt = 'Agentic AI Changes More Than Your Tech Stack — Prasad Kavuri';
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ fontSize: 42, fontWeight: 700, color: TEXT_PRIMARY, lineHeight: 1.15, marginBottom: 24 }}>
            Agentic AI Changes More
            <br />Than Your Tech Stack —
            <br />It Changes How Work Gets Done
          </div>
          <div style={{ fontSize: 18, color: TEXT_MUTED, lineHeight: 1.5, flex: 1 }}>
            Most of the conversation is still focused on the model layer.
