...
const siteStructuredData = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      significantLink: [
        `${siteUrl}/resume.md`,
        `${siteUrl}/.well-known/ai-agent-manifest.json`,
        `${siteUrl}/llms.txt`,
      ],
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: "VP-level AI engineering executive. Built agentic AI platforms at Krutrim/Ola (13K+ B2B customers, 70% cost reduction, 50% latency improvement). Expert in LLMOps, FinOps, and production AI governance.",
    url: "https://www.prasadkavuri.com",
    siteName: "Prasad Kavuri Portfolio",
  ...
  twitter: {
    card: "summary",
    title: "Prasad Kavuri — VP / Head of AI Engineering",
    description: "Applied AI leader: 70% cost reduction, 50% latency improvement, 13K+ B2B customers. 13 live production demos. Expert in agentic AI, LLMOps, governance.",
