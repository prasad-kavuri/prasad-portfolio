...
const KNOWLEDGE_BASE = [
  ...
  { id: 5, title: 'HERE Technologies — Autonomous Driving', content: 'Led global engineering teams across North America, Europe, and APAC at HERE Technologies. Delivered autonomous driving datasets for major OEMs while driving 50% cost reduction through cloud migration strategies.' },
...
export default function RAGPipelinePage() {
  ...
  const jsonLd = {
    ...
    keywords: 'Transformers.js, all-MiniLM-L6-v2, In-browser retrieval',
