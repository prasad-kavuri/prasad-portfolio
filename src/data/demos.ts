...
export const demos: Demo[] = [
  ...
  },
  {
    ...
    emoji: "Plug",
    title: "MCP Tool Demo",
    description: "MCP-style tool use — watch an LLM select and call JSON-Schema-defined tools (via Groq function calling) to answer questions about Prasad's background.",
  ...
  },
  {
    ...
    description: "Three-tier privacy-first AI pipeline: BERT NER redacts PII in the browser via Transformers.js ONNX, a HITL gate governs the handoff, and Groq produces an executive summary from the sanitized payload only.",
