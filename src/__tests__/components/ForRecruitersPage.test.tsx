...
describe('ForRecruitersPage', () => {
  ...
  it('renders guided evaluation path steps', () => {
    ...
    expect(screen.getByText(/Review operating model/i)).toBeInTheDocument();
  ...
  it('renders "Who this portfolio is built for" qualifier section', () => {
    ...
    expect(screen.getByText(/Currently Head of AI Platform & Agentic Solutions at Zip/i)).toBeInTheDocument();
  });
