...
const LAYERS: Layer[] = [
  {
    ...
    example: 'Portfolio Assistant: user asks "What AI platforms has Prasad led?" → validated, rate-checked, forwarded to orchestration.',
  },
  {
    id: 'orchestration',
    num: '02',
  ...
  },
  {
    ...
    example: 'MCP Demo: get_experience, search_skills, get_achievements — exposed as JSON-Schema tool definitions the model selects and calls.',
  },
  {
    id: 'model-router',
    num: '05',
  ...
  },
  {
    ...
    category: 'model',
    detail: 'Two inference paths: Groq API for server-side LLMs, and Transformers.js WASM for browser-local models (embeddings, PII redaction, quantization benchmarks).',
  ...
  },
  {
    ...
    num: '08',
    name: 'Evaluation',
    tagline: 'Rubric scoring · Offline suites · CI release gate',
    category: 'quality',
    ...
    tech: ['eval-engine.ts', 'Deterministic rubric scoring', 'Vitest eval suite', 'CI quality gate'],
