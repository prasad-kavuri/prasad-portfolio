...
export const alt = 'Prasad Kavuri — VP / Head of AI Engineering';
...
const metrics = [
  ...
  { value: '14', label: 'Production AI Demos' },
];

const pillars = ['Agentic AI', 'LLM Routing', 'AI Governance', 'RAG Pipelines', 'AI FinOps'];
