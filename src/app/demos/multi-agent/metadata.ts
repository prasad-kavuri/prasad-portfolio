...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Multi-Agent AI Orchestration with HITL | Prasad Kavuri',
    description:
      'Sequential agent handoffs with HITL checkpoint approval. Demonstrates production agentic AI patterns: Analyzer → Researcher → Strategist with governance controls.',
